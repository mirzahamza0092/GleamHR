...
class GetSpecificEmployeeService {
  static Future getSpecificEmployees({
    ...
    try {
      ...
      var request =
          http.Request('GET', Uri.parse("https://${Keys.domain}.gleamhrm.com/api/v3/employees/$userId"));
      ...
      if (response.statusCode == 200) {
        if (responseBody == '"Unauthenticated."') {
          ...
          Functions.reset();
          return specificEmployeeModelFromJson(responseBody);
        }
      } else {
