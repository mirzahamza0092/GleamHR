...
class GetAllCorrectionRequestService {
  static Future getAllCorrectionRequests({
    ...
    try {
      ...
      var request;
      if(status=="All"){
      request = http.Request('GET', Uri.parse("https://${Keys.domain}.gleamhrm.com/api/v3/requests/attendance-correction/$userId?page=$page"));
      }else{
      request = http.Request('GET', Uri.parse("https://${Keys.domain}.gleamhrm.com/api/v3/requests/attendance-correction/$userId?page=$page&status=$status"));
      }
